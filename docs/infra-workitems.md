...
| INF-028 | LensCloud message envelope for runner/operator failures | Platform handoff `lenscloud-platform/frappe-bench/apps/lenscloud/docs/handoffs/infra/lenscloud-message-envelope-runner-contract-20260720.md` | `bench-command-runner/runner.py`, `bench-command-runner/message_catalog.v1.json`, `bench-command-runner/test_message_envelope.py` | [lenscloud-message-envelope-evidence-20260720.md](./lenscloud-message-envelope-evidence-20260720.md), `python3 -m unittest bench-command-runner/test_message_envelope.py`, `scripts/59-test-bench-command-runner-local.sh` | [handoffs/platform/lenscloud-message-envelope-infra-return-20260720.md](./handoffs/platform/lenscloud-message-envelope-infra-return-20260720.md) and Platform copy `docs/handoffs/platform/lenscloud-message-envelope-infra-return-20260720.md` | Ready for Verification |
