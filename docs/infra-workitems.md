...
- CUA Site bootstrap and SSO: runner source is implemented for
  ...
  Platform enablement is pending runner image publication, digest pinning, and
  live verification on a real Site; OAuth/user/access commands remain
  `Unsupported`
