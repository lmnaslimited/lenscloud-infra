...
Infra has completed the CUA setup API readiness review for `INF-020`. The
setup wizard gate no longer requires a special LensPure branding/bootstrap app:
Frappe v16 provides the first-class setup API that the runner should call.
...
- CUA Site bootstrap and SSO: runner source is implemented for
  `site_setup.status` and `site_setup.complete` using native Frappe setup APIs;
  runner image publication, digest pinning, admission application, and live
  verification on a real Site are complete; Platform may integrate
  `site_setup`; OAuth runner source is implemented and locally verified for
  target Site `Social Login Key` status/configuration, and the runner image is
  published and repo-pinned at
  ...
  admission apply and live verification passed on 2026-07-07; Platform may
  adapt OAuth; `INF-026` adds the local/dev `allow_local_oauth_http` contract
  for `http://dev.localhost:8000`, is locally verified, and is published as
  ...
  the repo admission pin is updated, live cluster admission has been applied,
  and live verification passed on 2026-07-10;
  user/access commands remain `Unsupported`
- supporting handoff: [platform-bench-command-handoff.md](./platform-bench-command-handoff.md)
- Release Group app install and Bench update: runner source and admission
  family support are locally verified for `site_bootstrap.install_apps`,
  `site_app.install`, and `bench.update`; local `v0.1.12` image build passed;
  GHCR publish, digest pin, and live cluster proof remain pending
- LensCloud message envelope for runner/operator failures: source runner now
  emits a canonical nested `message` envelope for failed scoped POC operations,
  machine-readable catalog and local contract tests are committed; runner image
  digest is created and repo-pinned at
  ...
  live admission apply and `scripts/58-verify-platform-bench-command.sh`
...
| INF-020 | CUA native setup API readiness gate | Platform handoff `handoffs/infra/cua-site-bootstrap-sso-runner-20260703.md` | [cua-site-bootstrap-sso-runner-contract.md](./cua-site-bootstrap-sso-runner-contract.md), [cua-site-bootstrap-sso-implementation-prompt-20260706.md](./cua-site-bootstrap-sso-implementation-prompt-20260706.md) | [cua-native-setup-api-readiness-20260706.md](./cua-native-setup-api-readiness-20260706.md) | Platform no longer waits for a branding app image for setup wizard completion | Complete |
| INF-021 | CUA setup wizard runner gate | Platform handoff `handoffs/infra/cua-site-bootstrap-sso-runner-20260703.md` | [cua-site-bootstrap-sso-runner-contract.md](./cua-site-bootstrap-sso-runner-contract.md), `bench-command-runner/`, `scripts/64-verify-cua-site-setup-runner.sh` | [evidence/cua/site-setup-runner-evidence-20260706.md](./evidence/cua/site-setup-runner-evidence-20260706.md) | [handoffs/platform/cua-site-setup-runner-handoff-20260706.md](./handoffs/platform/cua-site-setup-runner-handoff-20260706.md) and Platform copy `docs/handoffs/platform/cua-site-setup-runner-20260706.md`; Platform may integrate `site_setup` through Bench Command | Complete |
| INF-022 | CUA OAuth runner gate | Platform handoff `handoffs/infra/cua-site-bootstrap-sso-runner-20260703.md` | [cua-site-bootstrap-sso-runner-contract.md](./cua-site-bootstrap-sso-runner-contract.md), `bench-command-runner/`, `scripts/65-verify-cua-oauth-runner.sh` | [evidence/cua/oauth-runner-evidence-20260706.md](./evidence/cua/oauth-runner-evidence-20260706.md) | [handoffs/platform/cua-oauth-runner-handoff-20260706.md](./handoffs/platform/cua-oauth-runner-handoff-20260706.md); Platform owns OAuth Client, Infra runner owns target Social Login Key | Complete |
| INF-025 | CUA OAuth configure runner failure follow-up | Platform handoff `handoffs/infra/cua-oauth-configure-runner-failed-20260707.md` | runner/site diagnostics; no Platform request shape change | [evidence/cua/oauth-configure-runner-failed-20260707.md](./evidence/cua/oauth-configure-runner-failed-20260707.md) | [handoffs/platform/cua-oauth-configure-runner-failed-20260707.md](./handoffs/platform/cua-oauth-configure-runner-failed-20260707.md) | Complete |
| INF-026 | CUA OAuth local-dev base URL runner contract | Platform handoff `lenscloud-platform/frappe-bench/apps/lenscloud/docs/handoffs/infra/cua-oauth-local-dev-base-url-runner-20260707.md` | [cua-site-bootstrap-sso-runner-contract.md](./cua-site-bootstrap-sso-runner-contract.md), [test-cluster-build-handoff-sop.md](./test-cluster-build-handoff-sop.md), `bench-command-runner/`, `scripts/59-test-bench-command-runner-local.sh`, `scripts/65-verify-cua-oauth-runner.sh`, `manifests/access/lenscloud-platform-rbac.yaml` | [evidence/cua/oauth-local-dev-base-url-runner-evidence-20260709.md](./evidence/cua/oauth-local-dev-base-url-runner-evidence-20260709.md) | [handoffs/platform/cua-oauth-local-dev-base-url-runner-20260709.md](./handoffs/platform/cua-oauth-local-dev-base-url-runner-20260709.md) and Platform copy `docs/handoffs/platform/cua-oauth-local-dev-base-url-runner-20260709.md` | Complete |
| INF-027 | Release Group app install and Bench update runner | Platform handoff `lenscloud-platform/frappe-bench/apps/lenscloud/docs/handoffs/infra/release-group-app-install-and-bench-upgrade-20260713.md` | [platform-bench-command-handoff.md](./platform-bench-command-handoff.md), [release-group-app-install-and-bench-upgrade-runner-sop-20260713.md](./release-group-app-install-and-bench-upgrade-runner-sop-20260713.md), `bench-command-runner/`, `scripts/59-test-bench-command-runner-local.sh`, `manifests/access/lenscloud-platform-rbac.yaml` | [release-group-app-install-and-bench-upgrade-evidence-20260713.md](./release-group-app-install-and-bench-upgrade-evidence-20260713.md) | [handoffs/platform/release-group-app-install-and-bench-upgrade-20260713.md](./handoffs/platform/release-group-app-install-and-bench-upgrade-20260713.md) | Ready for Verification |
| INF-028 | LensCloud message envelope for runner/operator failures | Platform handoff `lenscloud-platform/frappe-bench/apps/lenscloud/docs/handoffs/infra/lenscloud-message-envelope-runner-contract-20260720.md`; app-aware follow-up `lenscloud-platform/frappe-bench/apps/lenscloud/docs/handoffs/infra/app-aware-command-failure-envelope-recovery-20260721.md` | `bench-command-runner/runner.py`, `bench-command-runner/message_catalog.v1.json`, `bench-command-runner/test_message_envelope.py`; Release-runtime app-aware envelope contract | [lenscloud-message-envelope-evidence-20260720.md](./lenscloud-message-envelope-evidence-20260720.md), [app-aware-command-failure-envelope-evidence-20260721.md](./app-aware-command-failure-envelope-evidence-20260721.md), `python3 -m unittest bench-command-runner/test_message_envelope.py`, `scripts/59-test-bench-command-runner-local.sh`, `scripts/58-verify-platform-bench-command.sh` | [handoffs/platform/lenscloud-message-envelope-infra-return-20260720.md](./handoffs/platform/lenscloud-message-envelope-infra-return-20260720.md), [handoffs/platform/app-aware-command-failure-envelope-infra-return-20260721.md](./handoffs/platform/app-aware-command-failure-envelope-infra-return-20260721.md), and Platform copies under `docs/handoffs/platform/` | Ready for Verification |
| INF-029 | Customer provisioning Bench Command latency | Platform handoff `lenscloud-platform/frappe-bench/apps/lenscloud/docs/handoffs/infra/customer-provisioning-job-latency-under5-20260721.md` | `scripts/66-verify-customer-provisioning-job-latency.sh`, live `lenscloud-command-image-prewarm` DaemonSet | [customer-provisioning-job-latency-evidence-20260721.md](./customer-provisioning-job-latency-evidence-20260721.md) | [handoffs/platform/customer-provisioning-job-latency-infra-return-20260721.md](./handoffs/platform/customer-provisioning-job-latency-infra-return-20260721.md) and Platform copy under `docs/handoffs/platform/` | Ready for Verification |
| INF-030 | Customer Site creation app-install latency | Platform handoff `lenscloud-platform/frappe-bench/apps/lenscloud/docs/handoffs/infra/customer-site-creation-app-install-latency-20260721.md` | `frappe-operator` branch `lenscloud-beta` commit `1333c73a` with ConfigMap-driven FrappeSite init Job resources; live image `ghcr.io/lmnaslimited/frappe-operator@sha256:e22c78676cbfd87d9e8738763414be8f78eb2126d3cbb87c8f1b182a4ea9a4bf` | [customer-site-creation-app-install-latency-evidence-20260721.md](./customer-site-creation-app-install-latency-evidence-20260721.md), `GOCACHE=/private/tmp/lenscloud-go-build GOMODCACHE=/private/tmp/lenscloud-go-mod go test ./controllers` in `frappe-operator`, live proof Site `infra-latency-07211351` | [handoffs/platform/customer-site-creation-app-install-latency-infra-return-20260721.md](./handoffs/platform/customer-site-creation-app-install-latency-infra-return-20260721.md) and Platform copy under `docs/handoffs/platform/` | Ready for Verification |
| INF-029 | Customer provisioning command latency under five minutes | Platform handoff `lenscloud-platform/frappe-bench/apps/lenscloud/docs/handoffs/infra/customer-provisioning-job-latency-under5-20260721.md` | `scripts/66-verify-customer-provisioning-job-latency.sh`; live `lenscloud-command-image-prewarm` DaemonSet; operator-native `FrappeSite.spec.apps` recommendation | [customer-provisioning-job-latency-evidence-20260721.md](./customer-provisioning-job-latency-evidence-20260721.md) | [handoffs/platform/customer-provisioning-job-latency-infra-return-20260721.md](./handoffs/platform/customer-provisioning-job-latency-infra-return-20260721.md) and Platform copy `docs/handoffs/platform/customer-provisioning-job-latency-infra-return-20260721.md` | Returned to Platform |
| INF-023 | CUA user/access runner gate | Platform handoff `handoffs/infra/cua-site-bootstrap-sso-runner-20260703.md` | [cua-site-bootstrap-sso-runner-contract.md](./cua-site-bootstrap-sso-runner-contract.md), [cua-site-bootstrap-sso-implementation-prompt-20260706.md](./cua-site-bootstrap-sso-implementation-prompt-20260706.md) | TBD: `docs/cua-user-access-runner-evidence-<date>.md` | User/access commands remain `Unsupported` until user/access runner is implemented and live-verified | Planned |
